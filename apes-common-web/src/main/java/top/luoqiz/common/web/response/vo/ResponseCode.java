...
public enum ResponseCode {
    ...
    FAIL(-1, "系统繁忙"),
    SUCCESS(200, "请求成功"),
    NOT_SUPPORT_METHOD(405, "不支持此访问方式"),
    ...
    UPDATE_USER_PASSWORD_NON_COMPLIANT_RULE(10004, "新密码不符合规则"),
    ...
    // 注册
    REGISTER_USER_IS_EXIST(11100, "用户已存在"),
    REGISTER_PHONE_NOT_EXIST(11101, "手机号不允许为空"),
    REGISTER_PHONE_ERROR(11102, "手机号不正确"),
    REGISTER_VALIDATE_CODE_ERROR(11103, "验证码错误或已过期"),
    REGISTER_SMS_ERROR(11104, "短信发送失败"),

    //资源
    RESOURCE_NOT_FIND(12001, "无效的资源ID"),
    RESOURCE_IS_EXIST(12002, "资源ID已存在"),
    RESOURCE_PARENT_NOT_FIND(12003, "无效资源父节点ID"),
    RESOURCE_PARENT_INVALID(12004, "无效资源父节点ID"),
    RESOURCE_HAVE_SUB(12005, "该资源下有子资源，不能删除"),
